try{
  ...
  e._sentryDebugIds[a]="9ff1808b-ee98-4d20-9b28-e402c7bc86f7",
  e._sentryDebugIdIdentifier="sentry-dbid-9ff1808b-ee98-4d20-9b28-e402c7bc86f7")
}catch(e){
}{
  let e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{
  };
    ...
    execute:function(){
      e((()=>{
        ...
        b={
          ...
          r){
            ...
            var t={
              ...
              r.e(5344),
              r.e(6936),
              r.e(5806)]).then(()=>()=>r(11082)),
              "./tinaBlockTemplates":()=>Promise.all([r.e(883),
              r.e(2951),
              r.e(6765),
              r.e(6500),
              r.e(986),
        ...
        r){
          ...
          f(f)];
          for(var c=2&r&&a;
          ("object"==typeof c||"function"==typeof c)&&!~e.indexOf(c);
          c=f(c))Object.getOwnPropertyNames(c).forEach(e=>d[e]=()=>a[e]);
          return d.default=()=>a,
          s.d(t,
          d),
          t
        ...
        s.e=e=>Promise.all(Object.keys(s.f).reduce((a,
        r)=>(s.f[r](e,
        a),
        a),
        [])),
        ...
        t)=>{
          if(d[e])d[e].push(a);
            ...
            var f,
            n;
            if(void 0!==r)for(var o=document.getElementsByTagName("script"),
            b=0;
            b<o.length;
            b++){
              var l=o[b];
            ...
            !(t.indexOf(f)>=0)){
              ...
              o=e=>{
                ...
                try{
                  var f=s(e);
                  if(!f)return;
                  var d=e=>e&&e.init&&e.init(s.S[r],
                  t);
                  if(f.then)return b.push(f.then(d,
                  a));
                  var c=d(f);
              ...
              s.e(4017),
              s.e(1270),
              s.e(6792)]).then(()=>()=>s(59081))),
              n("@rsgweb/locale-tools",
              "0.0.0",
              ()=>Promise.all([s.e(2497),
              s.e(3082),
              s.e(283),
              s.e(8622)]).then(()=>()=>s(68403))),
              n("@rsgweb/modules-core-carousel",
              "0.0.0",
              ()=>Promise.all([s.e(883),
              s.e(2951),
              s.e(6765),
              ...
              s.e(4453),
              s.e(3351),
              s.e(7807)]).then(()=>()=>s(42066))),
              n("@rsgweb/modules-core-engagement",
              "0.0.0",
              ()=>Promise.all([s.e(883),
              s.e(6765),
              s.e(4976),
              ...
              s.e(4255),
              s.e(5344),
              s.e(7469)]).then(()=>()=>s(28699))),
              n("@rsgweb/modules-core-group-of-items",
              "0.0.0",
              ()=>Promise.all([s.e(883),
              s.e(2951),
              s.e(6765),
              ...
              s.e(7301),
              s.e(8248),
              s.e(2860)]).then(()=>()=>s(44053))),
              n("@rsgweb/modules-core-highlights",
              "0.0.0",
              ()=>Promise.all([s.e(3600),
              s.e(4815),
              s.e(3082),
              s.e(2909),
              s.e(2199),
              ...
              s.e(2285),
              s.e(4852),
              s.e(3792)]).then(()=>()=>s(83792))),
              n("@rsgweb/rockstar-account",
              "0.0.0",
              ()=>Promise.all([s.e(5864),
              s.e(6583),
              s.e(3082),
              s.e(283),
              s.e(3331),
              ...
              s.e(5997),
              s.e(5847),
              s.e(5509)]).then(()=>()=>s(55509))),
              n("clsx",
              "2.1.1",
              ()=>s.e(4921).then(()=>()=>s(4921))),
              n("dompurify",
              "2.5.9",
              ()=>s.e(62).then(()=>()=>s(50062))),
              n("lodash-es",
              "4.18.1",
              ()=>Promise.all([s.e(4309),
              s.e(5505)]).then(()=>()=>s(65505))),
              n("react-dom",
              "18.3.1",
              ()=>Promise.all([s.e(162),
              s.e(3082)]).then(()=>()=>s(30162))),
              n("react-intersection-observer",
              "9.16.0",
              ()=>Promise.all([s.e(3082),
              s.e(6320)]).then(()=>()=>s(26320))),
              n("react-jsx-parser",
              "2.4.1",
              ()=>Promise.all([s.e(6932),
              s.e(3082)]).then(()=>()=>s(76932))),
              n("react-router-dom",
              "6.30.3",
              ()=>Promise.all([s.e(4269),
              s.e(3082),
              s.e(4017)]).then(()=>()=>s(74269))),
              n("react",
              "18.3.1",
              ()=>s.e(2581).then(()=>()=>s(22581))),
              n("text-balancer",
              "1.0.5",
              ()=>s.e(4016).then(()=>()=>s(34016))),
              o(25136),
              o(29441)),
        ...
        (()=>{
          ...
          r,
          t)=>{
            var f=t?(e=>Object.keys(e).reduce((a,
            r)=>(e[r].eager&&(a[r]=e[r]),
            a),
            {
            }))(a[r]):a[r];
          ...
          d){
            var c=s.I(a);
            return c&&c.then&&!t?c.then(e.bind(e,
            a,
            s.S[a],
            r,
            !1,
          ...
          b)=>{
            ...
            r,
            t,
            f)=>"Unsatisfied version "+t+" from "+(t&&e[r][t].from)+" of shared singleton module "+r+" (required "+a(f)+")")(d,
            c,
            u,
            o),
          ...
          n={
            ...
            16,
            0],
            ()=>s.e(3939).then(()=>()=>s(26320))),
            86805:()=>d("default",
            "@foundry/react",
            !1,
            [0],
            ()=>Promise.all([s.e(2951),
            s.e(2497),
            s.e(2954),
            s.e(9643),
            s.e(3740)]).then(()=>()=>s(33740))),
            10475:()=>d("default",
            "@rsgweb/modules-core-highlights",
            !1,
            [0],
            ()=>Promise.all([s.e(4852),
            s.e(1411)]).then(()=>()=>s(83792))),
            35643:()=>d("default",
            "@rsgweb/modules-core-carousel",
            !1,
            [0],
            ()=>Promise.all([s.e(3351),
            s.e(2066)]).then(()=>()=>s(42066))),
            59139:()=>d("default",
            "@rsgweb/modules-core-engagement",
            !1,
            [0],
            ()=>Promise.all([s.e(4255),
            s.e(1089)]).then(()=>()=>s(28699))),
            72527:()=>d("default",
            "@rsgweb/modules-core-group-of-items",
            !1,
            [0],
            ()=>s.e(4053).then(()=>()=>s(44053))),
            87486:()=>d("default",
            "text-balancer",
            !1,
            [1,
