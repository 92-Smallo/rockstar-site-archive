try{
  ...
  e._sentryDebugIds[a]="0aecec34-7a40-447d-8116-e8b5356158e5",
  e._sentryDebugIdIdentifier="sentry-dbid-0aecec34-7a40-447d-8116-e8b5356158e5")
}catch(e){
}{
  let e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{
  };
    ...
    execute:function(){
      e((()=>{
        ...
        r){
          ...
          d=t(d))Object.getOwnPropertyNames(d).forEach(e=>o[e]=()=>a[e]);
          return o.default=()=>a,
          P.d(n,
          o),
          n
        ...
        P.e=e=>Promise.all(Object.keys(P.f).reduce((a,
        t)=>(P.f[t](e,
        a),
        a),
        [])),
        ...
        n="@rockstargames/modules-gtao-license-plate:",
        P.l=(e,
        a,
        t,
        o)=>{
          if(r[e])r[e].push(a);
            ...
            var d,
            c;
            if(void 0!==t)for(var f=document.getElementsByTagName("script"),
            l=0;
            l<f.length;
            l++){
              var s=f[l];
        ...
        (()=>{
          ...
          r)=>{
            ...
            !(r.indexOf(n)>=0)){
              ...
              f=[];
              return"default"===t&&(c("@react-spring/web",
              "10.0.3",
              ()=>Promise.all([P.e(1181),
              P.e(3082),
              P.e(4017)]).then(()=>()=>P(31181))),
              c("@react-spring/web",
              "9.7.5",
              ()=>Promise.all([P.e(8722),
              P.e(3082),
              P.e(4017)]).then(()=>()=>P(58722))),
              c("@react-three/fiber",
              "7.0.29",
              ()=>Promise.all([P.e(7211),
              P.e(3082),
              P.e(7625)]).then(()=>()=>P(87211))),
              c("@rsgweb/locale-tools",
              "0.0.0",
              ()=>Promise.all([P.e(7338),
              P.e(4959),
              P.e(3082),
              P.e(283),
              P.e(3280)]).then(()=>()=>P(76602))),
              c("@rsgweb/modules-core-user-action-menu",
              "0.0.0",
              ()=>Promise.all([P.e(7338),
              P.e(6896),
              P.e(859),
              ...
              P.e(188),
              P.e(7503),
              P.e(677)]).then(()=>()=>P(75214))),
              c("@rsgweb/rockstar-account",
              "0.0.0",
              ()=>Promise.all([P.e(6896),
              P.e(6583),
              P.e(3082),
              P.e(283),
              P.e(5997),
              P.e(3331),
              P.e(799)]).then(()=>()=>P(90799))),
              c("@rsgweb/utils",
              "0.0.0-development",
              ()=>Promise.all([P.e(6896),
              P.e(9988),
              ...
              P.e(283),
              P.e(5997),
              P.e(8940)]).then(()=>()=>P(18940))),
              c("@use-gesture/react",
              "10.3.1",
              ()=>Promise.all([P.e(6429),
              P.e(3082)]).then(()=>()=>P(86429))),
              c("gsap",
              "3.12.5",
              ()=>P.e(3529).then(()=>()=>P(93529))),
              c("lodash-es",
              "4.18.1",
              ()=>P.e(2042).then(()=>()=>P(92042))),
              c("react-dom",
              "18.3.1",
              ()=>Promise.all([P.e(162),
              P.e(3082)]).then(()=>()=>P(30162))),
              c("react-router-dom",
              "6.30.3",
              ()=>Promise.all([P.e(4269),
              P.e(3082),
              P.e(4017)]).then(()=>()=>P(74269))),
              c("react",
              "18.3.1",
              ()=>P.e(2581).then(()=>()=>P(22581))),
              c("stackblur-canvas",
              "2.7.0",
              ()=>P.e(9830).then(()=>()=>P(9830))),
              c("three",
              "0.141.0",
              ()=>P.e(2090).then(()=>()=>P(92090)))),
        ...
        (()=>{
          ...
          !e)){
            ...
            if(t.length)for(var r=t.length-1;
            r>-1&&(!e||!/^http(s?):/.test(e));
            )e=t[r--].src
        ...
        a,
        t,
        r)=>"Unsatisfied version "+t+" from "+(t&&e[a][t].from)+" of shared singleton module "+a+" (required "+c(r)+")",
        h=e=>{
          throw new Error(e)
        },
        p=e=>{
        ...
        a,
        t)=>t?t():((e,
        a)=>h("Shared module "+a+" doesn't exist in shared scope "+e))(e,
        a),
        g=(e=>function(a,
        t,
        r,
        ...
        o){
          var d=P.I(a);
          return d&&d.then&&!r?d.then(e.bind(e,
          a,
          P.S[a],
          t,
          !1,
        ...
        v={
          ...
          ()=>Promise.all([P.e(7338),
          P.e(4959),
          P.e(6602)]).then(()=>()=>P(76602))),
          13331:()=>g("default",
          "@rsgweb/utils",
          !1,
          [0],
          ()=>Promise.all([P.e(9988),
          P.e(8940)]).then(()=>()=>P(18940))),
          11436:()=>g("default",
          "@react-spring/web",
          !1,
          [0],
          ()=>P.e(1181).then(()=>()=>P(31181))),
          35812:()=>g("default",
          "gsap",
          !1,
          [0],
          ...
          3,
          1],
          ()=>P.e(6429).then(()=>()=>P(86429))),
          82199:()=>g("default",
          "@rsgweb/rockstar-account",
          !1,
          [0],
          ()=>Promise.all([P.e(6583),
          P.e(799)]).then(()=>()=>P(90799))),
          97625:()=>g("default",
          "three",
          !1,
          ...
          !1,
          [0],
          ()=>P.e(7211).then(()=>()=>P(87211))),
          76923:()=>g("default",
          "@rsgweb/modules-core-user-action-menu",
          !1,
          [0],
          ()=>Promise.all([P.e(5461),
          P.e(7503)]).then(()=>()=>P(75214)))
        },
        w={
          188:[11436,
          35812,
