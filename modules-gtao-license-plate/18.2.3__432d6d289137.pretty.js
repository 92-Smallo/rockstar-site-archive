try{
  ...
  e._sentryDebugIds[t]="b6f787a1-aa47-403d-81f7-fd9474e52979",
  e._sentryDebugIdIdentifier="sentry-dbid-b6f787a1-aa47-403d-81f7-fd9474e52979")
}catch(e){
}{
  let e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{
  };
    ...
    execute:function(){
      e((()=>{
        ...
        r){
          ...
          d=a(d))Object.getOwnPropertyNames(d).forEach(e=>o[e]=()=>t[e]);
          return o.default=()=>t,
          P.d(n,
          o),
          n
        ...
        P.e=e=>Promise.all(Object.keys(P.f).reduce((t,
        a)=>(P.f[a](e,
        t),
        t),
        [])),
        ...
        o)=>{
          if(r[e])r[e].push(t);
            ...
            var d,
            f;
            if(void 0!==a)for(var c=document.getElementsByTagName("script"),
            l=0;
            l<c.length;
            l++){
              var s=c[l];
        ...
        (()=>{
          ...
          r)=>{
            ...
            !(r.indexOf(n)>=0)){
              ...
              e[a]=c.length?Promise.all(c).then(()=>e[a]=1):1
            }
          }
        })(),
        (()=>{
          ...
          !e)){
            ...
            if(a.length)for(var r=a.length-1;
            r>-1&&(!e||!/^http(s?):/.test(e));
            )e=a[r--].src
        ...
        t,
        a,
        r)=>"Unsatisfied version "+a+" from "+(a&&e[t][a].from)+" of shared singleton module "+t+" (required "+f(r)+")",
        h=e=>{
          throw new Error(e)
        },
        p=e=>{
        ...
        t,
        a)=>a?a():((e,
        t)=>h("Shared module "+t+" doesn't exist in shared scope "+e))(e,
        t),
        g=(e=>function(t,
        a,
        r,
