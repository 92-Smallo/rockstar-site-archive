try{
  ...
  e._sentryDebugIds[a]="002b1571-d071-4a9f-bc27-876d26cf31ec",
  e._sentryDebugIdIdentifier="sentry-dbid-002b1571-d071-4a9f-bc27-876d26cf31ec")
}catch(e){
}{
  let e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{
  };
    ...
    execute:function(){
      e((()=>{
        ...
        o={
          ...
          r){
            ...
            a){
              ...
              r.href=e;
              for(var t="/"===r.pathname[0]?r.pathname:"/"+r.pathname,
              d=0,
              c=t.length;
              d!==a&&c>=0;
              )"/"===t[--c]&&d++;
          ...
          r){
            ...
            var t={
              ...
              r.e(3517),
              r.e(3331),
              r.e(6629)]).then(()=>()=>r(80917))
            },
            d=(e,
            a)=>(r.R=a,
            a=r.o(t,
            e)?t[e]():Promise.resolve().then(()=>{
        ...
        t){
          ...
          r(r)];
          for(var f=2&t&&a;
          ("object"==typeof f||"function"==typeof f)&&!~e.indexOf(f);
          f=r(f))Object.getOwnPropertyNames(f).forEach(e=>c[e]=()=>a[e]);
          return c.default=()=>a,
          i.d(d,
          c),
          d
        ...
        c)=>{
          if(t[e])t[e].push(a);
            ...
            var f,
            o;
            if(void 0!==r)for(var n=document.getElementsByTagName("script"),
            l=0;
            l<n.length;
            l++){
              var b=n[l];
        ...
        (()=>{
          ...
          t)=>{
            ...
            !(t.indexOf(d)>=0)){
              ...
              n=[];
              switch(r){
                case"default":o("@foundry-int/utils",
                "6.2.0",
                ()=>Promise.all([i.e(5721),
                i.e(1270)]).then(()=>()=>i(45721))),
                o("@foundry/icons",
                "6.2.0",
                ()=>Promise.all([i.e(4976),
                i.e(4637),
                i.e(6653),
                i.e(1433)]).then(()=>()=>i(64976))),
                o("@radix-ui/react-accordion",
                "1.2.12",
                ()=>Promise.all([i.e(1010),
                i.e(4637),
                i.e(4017),
                i.e(9394),
                i.e(7793),
                i.e(9793)]).then(()=>()=>i(81010))),
                o("@radix-ui/react-dialog",
                "1.1.15",
                ()=>Promise.all([i.e(5860),
                i.e(8819),
                i.e(4637),
                i.e(4017),
                i.e(9394),
                i.e(7793),
                i.e(1172),
                i.e(2174)]).then(()=>()=>i(88819))),
                o("@radix-ui/react-focus-scope",
                "1.1.7",
                ()=>Promise.all([i.e(4637),
                i.e(4017),
                i.e(9394),
                i.e(3876)]).then(()=>()=>i(83876))),
                o("@radix-ui/react-focus-scope",
                "1.1.8",
                ()=>Promise.all([i.e(4637),
                i.e(4017),
                i.e(7937),
                i.e(4956)]).then(()=>()=>i(4956))),
                o("@radix-ui/react-id",
                "1.1.1",
                ()=>Promise.all([i.e(4637),
                i.e(6883)]).then(()=>()=>i(96883))),
                o("@radix-ui/react-navigation-menu",
                "1.2.14",
                ()=>Promise.all([i.e(5860),
                i.e(9067),
                i.e(4637),
                ...
                i.e(7793),
                i.e(4293),
                i.e(4555)]).then(()=>()=>i(79067))),
                o("@radix-ui/react-popover",
                "1.1.15",
                ()=>Promise.all([i.e(5860),
                i.e(8295),
                i.e(4637),
                ...
                i.e(7793),
                i.e(1172),
                i.e(1421)]).then(()=>()=>i(41421))),
                o("@radix-ui/react-portal",
                "1.1.10",
                ()=>Promise.all([i.e(4637),
                i.e(4017),
                i.e(7937),
                i.e(9190)]).then(()=>()=>i(29190))),
                o("@radix-ui/react-portal",
                "1.1.9",
                ()=>Promise.all([i.e(4637),
                i.e(4017),
                i.e(9394),
                i.e(5204)]).then(()=>()=>i(2823))),
                o("@radix-ui/react-slot",
                "1.2.3",
                ()=>Promise.all([i.e(4637),
                i.e(2976)]).then(()=>()=>i(2976))),
                o("@radix-ui/react-slot",
                "1.2.4",
                ()=>Promise.all([i.e(4637),
                i.e(8957)]).then(()=>()=>i(38957))),
                o("@radix-ui/react-use-controllable-state",
                "1.2.2",
                ()=>Promise.all([i.e(4637),
                i.e(2463)]).then(()=>()=>i(12463))),
                o("@radix-ui/react-visually-hidden",
                "1.2.3",
                ()=>Promise.all([i.e(4637),
                i.e(4017),
                i.e(9394),
                i.e(5047)]).then(()=>()=>i(45047))),
                o("@radix-ui/react-visually-hidden",
                "1.2.4",
                ()=>Promise.all([i.e(4637),
                i.e(4017),
                i.e(7937),
                i.e(5922)]).then(()=>()=>i(3541))),
                o("@rsgweb/locale-tools",
                "0.0.0",
                ()=>Promise.all([i.e(2080),
                i.e(2145),
                i.e(2497),
                i.e(31),
                i.e(4637),
                i.e(8403)]).then(()=>()=>i(68403))),
                ...
                i.e(1270),
                i.e(7342),
                i.e(3517)]).then(()=>()=>i(67342))),
                o("@rsgweb/rockstar-account",
                "0.0.0",
                ()=>Promise.all([i.e(7147),
                i.e(31),
                i.e(6583),
                i.e(4637),
                i.e(5997),
                i.e(2909),
                i.e(3331),
                i.e(799)]).then(()=>()=>i(90799))),
                o("@rsgweb/utils",
                "0.0.0-development",
                ()=>Promise.all([i.e(2145),
                i.e(7147),
                i.e(31),
                i.e(1378),
                i.e(4637),
                i.e(5997),
                i.e(2909),
                i.e(8940)]).then(()=>()=>i(18940))),
                o("@vanilla-extract/recipes",
                "0.5.7",
                ()=>Promise.all([i.e(6260),
                i.e(8614)]).then(()=>()=>i(78614))),
                o("clsx",
                "2.1.1",
                ()=>i.e(4921).then(()=>()=>i(4921))),
                o("framer-motion",
                "12.38.0",
                ()=>Promise.all([i.e(6663),
                i.e(4637),
                i.e(6936)]).then(()=>()=>i(36663))),
                o("gsap",
                "3.12.5",
                ()=>i.e(3529).then(()=>()=>i(93529))),
                o("react-dom",
                "18.3.1",
                ()=>Promise.all([i.e(162),
                i.e(4637)]).then(()=>()=>i(30162))),
                o("react-remove-scroll",
                "2.7.2",
                ()=>Promise.all([i.e(1924),
                i.e(4637)]).then(()=>()=>i(31924))),
                o("react",
                "18.3.1",
                ()=>i.e(2581).then(()=>()=>i(22581))),
                o("spatial-navigation-polyfill",
                "1.3.1",
                ()=>i.e(4446).then(()=>()=>i(54446)));
                break;
                case"header":o("@foundry/react",
                "6.2.0",
                ()=>Promise.all([i.e(5860),
                i.e(2080),
                i.e(6260),
        ...
        (()=>{
          ...
          var a=i.g.document;
          if(!e&&a&&(a.currentScript&&"SCRIPT"===a.currentScript.tagName.toUpperCase()&&(e=a.currentScript.src),
          !e)){
            var r=a.getElementsByTagName("script");
            if(r.length)for(var t=r.length-1;
            t>-1&&(!e||!/^http(s?):/.test(e));
            )e=r[t--].src
        ...
        (()=>{
          ...
          c){
            var f=i.I(a);
            return f&&f.then&&!t?f.then(e.bind(e,
            a,
            i.S[a],
            r,
            !1,
          ...
          t)=>{
            var d=t?f(e[r]):e[r];
            return(r=Object.keys(d).reduce((e,
            r)=>!e||a(e,
            r)?r:e,
            0))&&d[r]
          })(r,
          ...
          s)=>{
            ...
            a,
            t,
            d)=>"Unsatisfied version "+t+" from "+(t&&e[a][t].from)+" of shared singleton module "+a+" (required "+r(d)+")")(o,
            i,
            h,
            b),
          ...
          u={
            ...
            2,
            4],
            ()=>Promise.all([i.e(4017),
            i.e(7937),
            i.e(3541)]).then(()=>()=>i(3541))),
            94555:()=>b("default",
            "@foundry-int/utils",
            !1,
            [0],
            ...
            i.e(9394),
            i.e(1172),
            i.e(3802)]).then(()=>()=>i(41421))),
            52920:()=>b("default",
            "@foundry/icons",
            !1,
            [0],
            ()=>Promise.all([i.e(4976),
            i.e(7001)]).then(()=>()=>i(64976))),
            80676:()=>b("default",
