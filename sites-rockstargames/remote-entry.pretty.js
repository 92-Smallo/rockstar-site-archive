try{
  ...
  e._sentryDebugIds[a]="a1c8da6a-b917-4d44-94e5-820a1ba3ea83",
  e._sentryDebugIdIdentifier="sentry-dbid-a1c8da6a-b917-4d44-94e5-820a1ba3ea83")
}catch(e){
}{
  let e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{
  };
    ...
    execute:function(){
      e((()=>{
        ...
        t){
          ...
          r=m(r))Object.getOwnPropertyNames(r).forEach(e=>f[e]=()=>a[e]);
          return f.default=()=>a,
          _.d(d,
          f),
          d
            ...
            !(d.indexOf(f)>=0)){
              ...
              b=e=>{
                ...
                try{
                  var f=_(e);
                  if(!f)return;
                  var r=e=>e&&e.init&&e.init(_.S[t],
                  d);
                  if(f.then)return n.push(f.then(r,
                  a));
                  var c=r(f);
        ...
        (()=>{
          ...
          !e)){
            ...
            if(t.length)for(var d=t.length-1;
            d>-1&&(!e||!/^http(s?):/.test(e));
            )e=t[d--].src
        ...
        (()=>{
          ...
          t,
          d)=>{
            var f=d?(e=>Object.keys(e).reduce((a,
            t)=>(e[t].eager&&(a[t]=e[t]),
            a),
            {
            }))(a[t]):a[t];
          ...
          r){
            var c=_.I(a);
            return c&&c.then&&!d?c.then(e.bind(e,
            a,
            _.S[a],
            t,
            !1,
          ...
          n)=>{
            ...
            t,
            d,
            f)=>"Unsatisfied version "+d+" from "+(d&&e[t][d].from)+" of shared singleton module "+t+" (required "+a(f)+")")(r,
            c,
            i,
            b),
          ...
          o={
            ...
            !1,
            [0],
            ()=>Promise.all([_.e(4976),
            _.e(7001)]).then(()=>()=>_(64976))),
            8830:()=>r("default",
            "@foundry/icons",
            !1,
            [0],
            ()=>Promise.all([_.e(4566),
            _.e(9071)]).then(()=>()=>_(74566))),
            86805:()=>r("default",
            "@foundry/react",
            !1,
            [0],
